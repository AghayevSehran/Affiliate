...
export class LiveCasinoReportsPage {
    ...
    getReports() {
        ...
        loading.present();
        this.partnerService.getLiveCasinoReports(this.reportFilter).then(response => {
            loading.dismiss();
    ...
    presentFilter() {
        let modal = this.modalCtrl.create(ReportLiveCasinoFilterPage, this.reportFilter);
        modal.present();
...
export class ReportLiveCasinoFilterPage {
    filterSettings: any = [];
