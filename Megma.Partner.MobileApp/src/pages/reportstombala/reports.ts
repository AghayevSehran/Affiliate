...
export class TombalaReportsPage {
    reportFilter: any;
    nodes: any;
    searchParams: any;
    ...
    getReports() {
        ...
        loading.present();
        this.partnerService.getTombalaReports(this.reportFilter).then(response => {
            loading.dismiss();
    ...
    presentFilter() {
        let modal = this.modalCtrl.create(ReportTombalaFilterPage, this.reportFilter);
        modal.present();
...
export class ReportTombalaFilterPage {
    filterSettings: any = [];
