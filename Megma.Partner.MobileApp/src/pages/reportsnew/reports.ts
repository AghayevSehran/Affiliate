...
export class ReportsNew {
    ...
    getReports() {
        ...
        loading.present();
        this.partnerService.PartnerShopReport(this.reportFilter).then(response => {
            loading.dismiss();
    ...
    presentFilter() {
        let modal = this.modalCtrl.create(ReportsNewFilter, this.reportFilter);
        modal.present();
