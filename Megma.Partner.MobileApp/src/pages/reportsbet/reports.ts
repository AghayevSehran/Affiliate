...
export class BetReportsPage {
    ...
    getReports() {
        ...
        loading.present();
        this.partnerService.getBetReports(this.reportFilter).then(response => {
            loading.dismiss();
    ...
    presentFilter() {
        let modal = this.modalCtrl.create(ReportBetFilterPage, this.reportFilter);
        modal.present();
...
export class ReportBetFilterPage {
    filterSettings: any = [];
